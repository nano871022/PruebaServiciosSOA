...
public class QuizWebService {
	...
	@EJB(mappedName="ejb:/ejb3-server-war-0.0.1-SNAPSHOT//PlayedQuizzesCounterBean!com.letsprog.learning.ejb3.server.api.IRemotePlayedQuizzesCounter")
	...
	public Response start(@javax.ws.rs.core.Context HttpServletRequest request,
		...
		quizProxy = (IRemoteQuiz) wildf9Lookerup.findRemoteSessionBean(LookerUp.SessionBeanType.STATELESS, earName, moduleName,deploymentDistinctName, beanName, interfaceQualifiedName);
